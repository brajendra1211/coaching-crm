...
@section('page_title', 'Add Website Page')
    ...
    <div class="page-builder-wrap">
        <div>
            <div class="builder-card">
                <div class="builder-head">
                    ...
                    <p>Create SEO friendly website pages like About, Contact, Admission, Results, Gallery etc.</p>
                </div>
                ...
                <div class="builder-body">
                    <div class="form-grid-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" id="titleInput" value="{{ old('title') }}" placeholder="About Our Coaching" required>
                            @error('title') <span class="error-text">{{ $message }}</span> @enderror
                        </div>

                        <div class="form-group">
                            <label>URL Slug</label>
                            <input type="text" name="slug" id="slugInput" value="{{ old('slug') }}" placeholder="about-us">
                            <span class="input-help">Blank chhodne par title se auto generate hoga.</span>
                    ...
                    <div class="form-grid-2">
                        <div class="form-group">
                            ...
                            @php $selectedType = old('page_type', 'default'); @endphp
                        ...
                        <div class="form-group">
                            ...
                            <span class="input-help">Menu/footer me order ke liye use hoga.</span>
            ...
            <div class="builder-card">
                <div class="builder-head">
                    <h3>Hero Section</h3>
                    <p>Page ke top section ke liye title, subtitle aur optional hero image add karein.</p>
                </div>

                <div class="builder-body">
                    <div class="form-group">
                        <label>Hero Title</label>
                        <input type="text" name="hero_title" value="{{ old('hero_title') }}" placeholder="Best Coaching Institute for Smart Preparation">
                        @error('hero_title') <span class="error-text">{{ $message }}</span> @enderror
                    </div>

                    <div class="form-group">
                        <label>Hero Subtitle</label>
                        <textarea name="hero_subtitle" placeholder="Write short and powerful intro for this page...">{{ old('hero_subtitle') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="image-upload-box">
                            ...
                            <span class="input-help">
                                Optional. Recommended size 900x650px. JPG, PNG, WebP allowed. Max 4MB.
                            </span>
                            <img id="heroImagePreview" class="image-preview" alt="Hero image preview">
                        </div>
            ...
            <div class="builder-card">
                <div class="builder-head">
                    <h3>Page Content</h3>
                    <p>SEO content, headings, paragraphs, lists and details yahan add karein.</p>
                </div>
            ...
            <div class="builder-card">
                <div class="builder-head">
                    <h3>CTA Section</h3>
                    <p>Page ke bottom me enquiry/call action ke liye CTA content.</p>
                </div>

                <div class="builder-body">
                    <div class="form-group">
                        <label>CTA Title</label>
                        <input type="text" name="cta_title" value="{{ old('cta_title') }}" placeholder="Book Free Counselling Session">
                        @error('cta_title') <span class="error-text">{{ $message }}</span> @enderror
                    </div>

                    <div class="form-group">
                        <label>CTA Description</label>
                        <textarea name="cta_description" placeholder="Our counsellor will help you choose the right course and batch.">{{ old('cta_description') }}</textarea>
            ...
            <div class="builder-card">
                <div class="builder-head">
                    <h3>SEO Settings</h3>
                    <p>Google ranking ke liye meta title, description aur keywords set karein.</p>
                </div>

                <div class="builder-body">
                    <div class="form-group">
                        <label>SEO Title</label>
                        <input type="text" name="seo_title" id="seoTitleInput" value="{{ old('seo_title') }}" maxlength="255" placeholder="Best Coaching Institute in Noida | Admission Open">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="seo_description" id="seoDescInput" maxlength="300" placeholder="Write 150-160 character SEO description...">{{ old('seo_description') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="seo_keywords" placeholder="coaching institute, best coaching, admission open">{{ old('seo_keywords') }}</textarea>
            ...
            <div class="action-row">
                <button type="submit" class="admin-btn admin-btn-primary">Save Website Page</button>
        ...
        <aside class="side-card">
            <div class="side-head">
                ...
                <p>Page status, enquiry form aur SEO preview.</p>
            </div>
            ...
            <div class="side-body">
                ...
                <label class="check-card">
                    <input type="checkbox" name="show_enquiry_form" value="1" {{ old('show_enquiry_form', 1) ? 'checked' : '' }}>
                    <div>
                ...
                <div class="preview-box">
                    ...
                    <strong id="urlPreview">{{ url('/') }}/page-url</strong>
                </div>

                <div class="seo-preview">
                    <div class="seo-preview-title" id="seoTitlePreview">SEO title will show here</div>
                    <div class="seo-preview-url" id="seoUrlPreview">{{ url('/') }}/page-url</div>
                    <div class="seo-preview-desc" id="seoDescPreview">SEO description will show here.</div>
                </div>

                <div style="margin-top:18px;">
                    <strong style="display:block;color:#111827;margin-bottom:8px;">SEO Tips</strong>
                    <ul class="tips-list">
                        <li>Title me main keyword add karein.</li>
                        <li>Description 150-160 characters ke andar rakhein.</li>
                        <li>Content me H2/H3 headings add karein.</li>
                        <li>Local keyword jaise city/area add karein.</li>
                        <li>Hero image compressed WebP/JPG upload karein.</li>
                    </ul>
                </div>
            </div>
        </aside>
...
<script>
    ...
    pageTypeSelect.addEventListener('change', function () {
        if (pageTypeSelect.value === 'contact' && !slugManuallyChanged) {
            titleInput.value = titleInput.value || 'Contact Us';
            slugInput.value = 'contact';
            updatePreview();
        }

        if (pageTypeSelect.value === 'results' && !slugManuallyChanged) {
            titleInput.value = titleInput.value || 'Results';
            slugInput.value = 'results';
            updatePreview();
        }

        if (pageTypeSelect.value === 'courses' && !slugManuallyChanged) {
            titleInput.value = titleInput.value || 'Courses';
            slugInput.value = 'courses';
            updatePreview();
        }
    });
